...
st.markdown("""
    ...
    .stButton>button {
        ...
        box-shadow: 0px 8px 0px #a71c2a; width: 50%; margin: 0 auto; display: block;
    }
    ...
    .money-fill { 
        ...
        background-size: 50px 50px; animation: barberpole 4s linear infinite; height: 100%; 
    }
    .cv-fill {
        background-image: linear-gradient(45deg, #ff9ff3 25%, #f368e0 25%, #f368e0 50%, #ff9ff3 50%, #ff9ff3 75%, #f368e0 75%, #f368e0 100%);
        background-size: 50px 50px; animation: barberpole 3s linear infinite; height: 100%;
    }
    .pit-fill-boss { background: linear-gradient(270deg, #ff6b6b, #feca57, #48dbfb, #ff9ff3, #54a0ff); background-size: 400% 400%; height: 100%; }

    /* --- CARDS --- */
    .player-card { background: white; border: 4px solid #000; border-radius: 15px; padding: 20px; margin-bottom: 30px; box-shadow: 8px 8px 0px rgba(0,0,0,0.2); }
    ...
    .player-header { display: flex; justify-content: space-between; align-items: center; border-bottom: 2px dashed #ddd; padding-bottom: 10px; margin-bottom: 15px;}
    .status-badge-pass { background: #2ed573; color: white; padding: 5px 10px; border-radius: 20px; border: 2px solid #000; font-size: 0.5em; }
    .status-badge-loading { background: #feca57; color: #000; padding: 5px 10px; border-radius: 20px; border: 2px solid #000; font-size: 0.5em; }
    
    .sub-label { font-family: 'Fredoka One', sans-serif; font-size: 0.7em; color: #FFF; text-shadow: 1px 1px 0px #000; margin-bottom: 4px; text-transform: uppercase; }
    .header-bordered { background: white; border: 4px solid #000; border-radius: 15px; padding: 20px; text-align: center; margin-bottom: 25px; }
    .stat-card { background: #fff; border: 3px solid #000; border-radius: 10px; padding: 8px; text-align: center; }
    </style>
